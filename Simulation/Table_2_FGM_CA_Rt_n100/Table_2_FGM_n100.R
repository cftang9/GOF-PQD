...
Table_2_FGM_Power_n100 = Table_2_FGM_Power/B
Table_2_FGM_Time_n100 = array(Table_2_FGM_Time[,1]/(B*length(Tau)),c(7,1))

# save(Table_2_FGM_Power_n100,
#      Table_2_FGM_Time_n100,
#      file="Table_2_FGM_n100.rdata")