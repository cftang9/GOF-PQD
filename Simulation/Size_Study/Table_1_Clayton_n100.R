...
Tau = c(0.1,0.2); 
Table_1_Clayton_Power = array(0,c(2,length(Tau)))
Table_1_Clayton_Time = array(0,c(2,length(Tau)))
...
Table_1_Clayton_Power_n100 = Table_1_Clayton_Power/B
Table_1_Clayton_Time_n100 = array(Table_1_Clayton_Time[,1]/(B*length(Tau)),c(2,1))

# save(Table_1_Clayton_Power_n100, 
#      Table_1_Clayton_Time_n100, 
#      file="Table_1_Clayton_n100.rdata")