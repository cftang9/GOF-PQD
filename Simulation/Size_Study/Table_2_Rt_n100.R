...
Table_2_Rt_Power_n100 = Table_2_Rt_Power/B
Table_2_Rt_Time_n100 = array(Table_2_Rt_Time[,1]/(B*length(Nu)),c(2,1))

# save(Table_2_Rt_Power_n100,
#      Table_2_Rt_Time_n100,
#      file="Table_2_Rt_n100.rdata")