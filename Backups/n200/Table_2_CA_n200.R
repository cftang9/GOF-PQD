...
Theta = c(0.05,0.10,0.15,0.20,0.25); 
...
Table_2_CA_Power_n200 = Table_2_CA_Power/B
Table_2_CA_Time_n200 = array(Table_2_CA_Time[,1]/(B*length(Theta)),c(7,1))

# save(Table_2_CA_Power_n200,
#      Table_2_CA_Time_n200,
#      file="Table_2_CA_n200.rdata")